...
export const SITE = {
  ...
  mobileHeroVideo: {
    src: 'img/hero/air-roasting-mobile-v3.mp4',
    poster: 'img/hero/air-roasting-mobile-v3-poster.webp',
...
export const MODEL_UI = {
  ...
  readyLabel: 'I’m Ready to Discuss the Details',
